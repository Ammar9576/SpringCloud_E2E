package com.nbc.custom_reports.util;
...
public class SwaggerConfig {
	...
	private static final String DESCRIPTION="This service provides API's to generate grand summary and dashboard details.";
    ...
    public Docket swaggerSpringfoxDocket() {
        ...
        return new Docket(DocumentationType.SWAGGER_2)
                ...
                .select().apis(RequestHandlerSelectors.basePackage("com.nbc.custom_reports.controller"))
